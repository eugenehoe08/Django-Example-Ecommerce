...
class ProductSerializer(serializers.ModelSerializer):
    ...
    # #     queryset=Collection.objects.all()  # serialize field
    # # )
    # # collection = serializers.StringRelatedField()
    # # collection = CollectionSerializer() # get collection item here
    ...
    # Override validate method when doing POST request
